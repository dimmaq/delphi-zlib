...
procedure GZCompressFile(const inFileName, outFileName: TFileName;
  const fileName, comment: AnsiString); overload;

procedure GZCompressFile(const inFileName, outFileName: TFileName;
  const comment: AnsiString); overload;

procedure GZCompressFile(const inFileName, outFileName: TFileName); overload;

procedure GZDecompressFile(const inFileName, outFolder: TFileName;
  var comment: AnsiString); overload;

procedure GZDecompressFile(const inFileName, outFolder: TFileName); overload;
